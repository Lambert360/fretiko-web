      ...
      <section className="py-20 bg-gradient-to-b from-black to-neon-cyan/5">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link 
              href="/about" 
              className="px-8 py-4 rounded-full font-semibold text-white border-2 border-neon-cyan transition-all duration-300 hover:scale-105 hover:bg-neon-cyan hover:text-black inline-block"
            >
              Learn More
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="http://linkedin.com/in/fretiko-ltd-60b012401" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-neon-purple/20 transition-colors">
                  <svg className="w-5 h-5 text-white/80" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/partners/login" className="text-white/60 hover:text-neon-cyan transition-colors">Partner Login</Link></li>
                <li><Link href="/partners/track" className="text-white/60 hover:text-neon-cyan transition-colors">Track Application</Link></li>
              </ul>
            </div>
